...
import coil.load
import com.athzaq.menitcom.databinding.ActivityDetailNewsUsactivityBinding

class DetailNewsUSActivity : AppCompatActivity() {

    private lateinit var binding : ActivityDetailNewsUsactivityBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityDetailNewsUsactivityBinding.inflate(layoutInflater)
